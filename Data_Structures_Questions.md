...
10. What is the runtime complexity of `DoublyLinkedList.delete`? O(1)
    ...
    I think the runtime complexity of the doubly linked list's delete method is O(1) while the worst case runtime of Array.splice is O(n) so delete will perform better.